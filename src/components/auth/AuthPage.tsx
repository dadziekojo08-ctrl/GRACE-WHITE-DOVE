            ...
            <div>
              ...
              <div className="mt-4 pt-3 border-t border-slate-100">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-[11px] font-bold text-slate-500 uppercase tracking-wider">Quick Demo Logins</span>
                ...
                <div className="grid grid-cols-2 gap-2 text-[11px]">
                  <button
                    type="button"
                    onClick={() => {
                      setEmail('kwesi.mensah@gracewhitedove.edu.gh');
                  ...
                  >
                    <div className="font-bold text-slate-800 group-hover:text-emerald-950 flex items-center gap-1">
                      <Lock className="w-3 h-3 text-amber-600 shrink-0" />
                      <span>Class 1 Teacher</span>
                    </div>
                    <div className="text-[10px] text-slate-500">Mr. Kwesi (Class 1 Only)</div>
                  </button>

                  <button
                    type="button"
                    onClick={() => {
                      setEmail('emmanuel.osei@gracewhitedove.edu.gh');
                      setPassword('teacher123');
                    }}
                    className="p-2 rounded-xl border border-slate-200 bg-slate-50 hover:bg-emerald-50 hover:border-emerald-300 text-left transition-all cursor-pointer group"
                  >
                    <div className="font-bold text-slate-800 group-hover:text-emerald-950 flex items-center gap-1">
                      ...
                      <span>JHS Teacher</span>
                    </div>
                    <div className="text-[10px] text-slate-500">Mr. Osei (JHS 1 to 3)</div>
                  </button>

                  <button
                    type="button"
                    onClick={() => {
                      setEmail('patience.coffie@gracewhitedove.edu.gh');
                      setPassword('teacher123');
                    }}
                    className="p-2 rounded-xl border border-slate-200 bg-slate-50 hover:bg-emerald-50 hover:border-emerald-300 text-left transition-all cursor-pointer group"
                  >
                    ...
                    <div className="text-[10px] text-slate-500">Mad. Patience (Creche Only)</div>
                  </button>

                  <button
                    type="button"
                    onClick={() => {
                      setEmail('rev.addo@gracewhitedove.edu.gh');
                  ...
                  >
                    ...
                    <div className="text-[10px] text-slate-500">Full School Oversight</div>
                  </button>
                </div>
              </div>
